...
requireAuth();
checkRole(['admin', 'doctor', 'staff', 'receptionist', 'finance staff']);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['upload_profile_picture'])) {
    ...
    if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] === UPLOAD_ERR_OK) {
        ...
        if (!in_array($file_type, $allowed_types)) {
            ...
            $new_filename = 'employee_profile_' . $profilePictureContext['identifier'] . '_' . time() . '.' . $file_extension;
...
<div class="mb-6">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400">Manage your department account information</p>
        </div>
    </div>
</div>
