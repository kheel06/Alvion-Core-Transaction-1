...
// Redirect unauthenticated visitors to the public landing page
...
$normalized_role_name = is_string($role_name)
    ? strtolower(str_replace(' ', '_', trim($role_name)))
    : $role_name;

// Map roles to dashboard files
$dashboard_map = [
    'admin' => 'dashboards/admin_dashboard.php',
    'doctor' => 'dashboards/doctor_dashboard.php',
    'nurse' => 'dashboards/nurse_dashboard.php',
    'receptionist' => 'dashboards/receptionist_dashboard.php',
    'appointment_coordinator' => 'dashboards/appointment_coordinator_dashboard.php',
    'billing_staff' => 'dashboards/billing_dashboard.php',
    'patient' => 'dashboards/patient_dashboard.php',
    'pharmacist' => 'dashboards/pharmacist_dashboard.php',
    'lab_technician' => 'dashboards/lab_technician_dashboard.php',
    'housekeeping' => 'dashboards/housekeeping_dashboard.php'
];

// Redirect to role-specific dashboard if exists
if (isset($dashboard_map[$normalized_role_name]) && file_exists($dashboard_map[$normalized_role_name])) {
    header("Location: " . $dashboard_map[$normalized_role_name]);
    exit;
}
