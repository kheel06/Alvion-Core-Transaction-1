...
<body class="h-full bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900">
        ...
        } elseif ($role_name === 'billing_staff' || $role_name === 'finance_staff' || $role_name === 'finance staff') {
            include 'sidebar_finance_staff.php';
                ...
                <div class="flex items-center justify-between px-6 py-3">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <div class="relative ml-2">
                            ...
                            // For patient role, always fetch email from users table (not username)
                            if ($is_patient_role && isset($_SESSION['user_id'])) {
                            ...
                            $display_role_badge = (!$is_patient_role && !$is_employee_role) ? ucfirst(str_replace('_', ' ', $role_name)) : '';
                            ...
                            <div id="userDropdown" class="hidden absolute top-full right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-2xl z-50 border border-gray-200 dark:border-gray-700 overflow-hidden">
                                ...
                                <div class="py-1">
                                    <?php
                                    $accountRoles = $employee_roles;
                                    $normalizedRole = $normalized_role;
                                    $accountLink = in_array($normalizedRole, $accountRoles, true)
                                        ? BASE_URL . '/modules/profile/employee-profile.php'
                                        : BASE_URL . '/modules/profile/profile.php';
                                    ?>
